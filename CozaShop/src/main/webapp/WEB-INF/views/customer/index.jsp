...
<body class="animsition">
	...
	<section class="section-slide">
		<div class="wrap-slick1">
			<div class="slick1">
				<div class="item-slick1" style="background-image: url(resources/web/images/slide-01.jpg);">
				...
				<div class="item-slick1" style="background-image: url(resources/web/images/slide-02.jpg);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
				...
				<div class="item-slick1" style="background-image: url(resources/web/images/slide-03.jpg);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
	...
	<section class="bg0 p-t-23 p-b-140">
		<div class="container">
			<div class="p-b-10">
				<h3 style="font-family: Verdana; font-weight: bold; text-align: center; color: black; font-size: 35px">
					SẢN PHẨM
				</h3>
			</div>
			...
			<div class="flex-w flex-sb-m p-b-52">
				<div class="flex-w flex-l-m filter-tope-group m-tb-10" >
					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 how-active1" data-filter="*" style="font-family: Verdana; font-size: 17px">
						Tất cả sản phẩm
					</button>

					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".women" style="font-family: Verdana; font-size: 17px">
						Áo sơ mi
					</button>

					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".men" style="font-family: Verdana;  font-size: 17px">
						Áo thun
					</button>

					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".bag" style="font-family: Verdana;  font-size: 17px">
						Túi
					</button>

					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".shoes" style="font-family: Verdana;  font-size: 17px">
						Giày
					</button>

					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".watches" style="font-family: Verdana; font-size: 17px">
						Đồng hồ
					</button>
				</div>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="resources/web/images/product-16.jpg" alt="IMG-PRODUCT">
	...
	<script>
		...
		$('.js-addcart-detail').each(function(){
			...
			$(this).on('click', function(){
				swal(nameProduct, "thêm sản phẩm thành công !", "success");
			});
		});
