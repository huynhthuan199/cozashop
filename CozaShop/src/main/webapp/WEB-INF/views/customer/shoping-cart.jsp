...
<body class="animsition">
	...
	<div class="container">
		<div class="bread-crumb flex-w p-l-25 p-r-15 p-t-30 p-lr-0-lg"  >
			<a href="index.html" class="stext-109 cl8 hov-cl1 trans-04"  style="font-size: 15px" >
				Trang chủ
				<i class="fa fa-angle-right m-l-9 m-r-10" aria-hidden="true"></i>
			</a>

			<span class="stext-109 cl4"  style="font-size: 15px">
				Giỏ hàng
			</span>
		</div>
	</div>
			...
			<div class="row">
					...
					<div class="m-l-25 m-r--38 m-lr-0-xl">
						<div class="wrap-table-shopping-cart" >
							<table class="table-shopping-cart" >
								<tr class="table_head" >
									<th class="column-1" style="font-family: Verdana; font-weight:bold; font-size: 13px">Sản phẩm</th>
									<th class="column-2" style="font-family: Verdana; font-weight:bold; font-size: 13px"></th>
									<th class="column-3" style="font-family: Verdana; font-weight:bold; font-size: 13px">Giá</th>
									<th class="column-4" style="font-family: Verdana; font-weight:bold; font-size: 13px">Số lượng</th>
									<th class="column-5" style="font-family: Verdana; font-weight:bold; font-size: 13px">Total</th>
								</tr>

								<tr class="table_row">
									<td class="column-1">
										<div class="how-itemcart1">
											<img src="resources/web/images/item-cart-04.jpg" alt="IMG">
										</div>
									</td>
						...
						<div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm" style="margin-top: 20px; width: 100%; margin-left: 0">
							<h4 class="mtext-109 cl2 p-b-30">
								THÔNG TIN
							</h4>
							<div class="form-group"> 
								<label class="control-label" for="first-name">Tên nhận hàng <span class="required">*</span>
								</label>               
							...
							<div class="form-group"> 
								<label class="control-label" for="first-name">Điện thoại <span class="required">*</span>
								</label>               
								<input type="text" id="first-name" required="required" class="form-control">
							</div>
							<div class="form-group" > 
								<label class="control-label" for="first-name">Địa chỉ <span class="required">*</span>
								</label>               
								<input type="text" id="first-name" required="required" class="form-control">
							</div>
				...
				<div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
					<div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
						<h4 class="mtext-109 cl2 p-b-30" style="font-family: Verdana; font-weight:bold">
							VẬN CHUYỂN
						</h4>
						<div class="">
							<div class="size-209 ">
								<span class="stext-110 cl2" style="font-family: Verdana">
									Phí giao hàng tận nơi
								</span>
							</div>
							<div class="form-check" style="margin-top: 25px; margin-left: 15px">
								<input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios1" value="option1" checked>
								<label class="form-check-label" for="exampleRadios1">
									Phí vận chuyển toàn quốc - 30.000đ
								</label>
							</div>
							<div class="logo" >
								<img src="resources/web/images/icons/unnamed.png" style="width: 95px;height: 100px">
								<img src="resources/web/images/icons/logo.png" style="width: 60px; margin-left: 25px">
								<img src="resources/web/images/icons/giao-hang-trong-ngay-ebay.jpg" style="width: 95px; height: 100px; margin-left: 25px">
							</div>
						</div>
					</div>
					<div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm" style="margin-top: 20px">
						...
						<button class="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer" style="font-family: Verdana; font-weight:bold">
							ĐẶT HÀNG
						</button>
					</div>
				</div>
