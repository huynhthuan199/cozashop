 ...
 <div
		...
		<div class="block2">
			<div class="block2-pic hov-img0">
				<img src="/resources/web/images/Products/${product.image }"
					alt="IMG-PRODUCT">
			...
			<div class="block2-txt flex-w flex-t p-t-14">
				<div class="block2-txt-child1 flex-col-l ">
					<a id="nameProduct" data-name="${product.name }"
						href="/productdetail/${product.id }"
						class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
						${product.name } </a> <span class="stext-105 cl3"><fmt:formatNumber type = "number" 
         maxFractionDigits = "3" value = "${product.price }" /> VNĐ </span>
				</div>
