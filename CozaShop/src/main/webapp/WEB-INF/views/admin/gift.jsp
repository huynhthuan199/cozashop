...
<body>
	...
	<div id="wrapper">
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="card">
							<div class="card-body">
								<div class="card-title text-info">Thông Tin Khuyến Mãi</div>
								<hr>
								<div class="form-group row">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control form-control-rounded"
											id="txtAddName" placeholder="Nhập tên khuyến mãi">
									</div>
								</div>
								<div class="form-group row">
									<label for="input-27" class="col-sm-2 col-form-label">Mã Khuyến Mãi</label>
									<div class="col-sm-10">
										<input type="text" class="form-control form-control-rounded"
											id="txtAddCode" placeholder="Nhập mã khuyến mãi">
									</div>
								</div>
								<div class="form-group row">
									<label for="input-27" class="col-sm-2 col-form-label">Tiền Giảm</label>
									<div class="col-sm-10">
										<input type="text" class="form-control form-control-rounded"
											id="txtAddMoney" placeholder="Nhập tiền giảm">
									</div>
								</div>
								<div class="form-group row">
							...
							<div class="card-body">
								<div class="table-responsive">
									<table id="default-datatable" class="table table-bordered">
										...
										<tbody>
											<c:forEach var="listGift" items="${listGift}">
												<tr class="even pointer">
													<td class=" ">${listGift.id }</td>
													<td class=" ">${listGift.name }</td>
													<td class=" ">
													<fmt:formatNumber type = "number" 
         maxFractionDigits = "3" value = "${listGift.money }" /></td>
													<td class=" ">${listGift.code }</td>
													<td class="valEnabled"><span
														class="badge badge-danger shadow-danger m-1 valEnabled1">${listGift.enabled == true ? "Bật" : "Tắt"}</span></td>
											<%-- 		<td class=" ">${listGift.createAt }</td> --%>
		...
		<div class="modal fade" id="edit-gift">
                    ...
                    <div class="modal-content animated lightSpeedIn">
                      ...
                      <div class="modal-body">
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control form-control-rounded"
									id="txtName" placeholder="Nhập tên khuyến mãi">
							</div>
						</div>
						<div class="form-group row">
							<label for="input-27" class="col-sm-2 col-form-label">Mã
								Khuyến Mãi</label>
							<div class="col-sm-10">
								<input type="text" class="form-control form-control-rounded"
									id="txtCode" placeholder="Nhập mã khuyến mãi">
							</div>
						</div>
						<div class="form-group row">
							<label for="input-27" class="col-sm-2 col-form-label">Tiền Giảm</label>
							<div class="col-sm-10">
								<input type="text" class="form-control form-control-rounded"
									id="txtMoney" placeholder="Nhập mã tiền giảm">
							</div>
						</div>
						<div class="form-group row">
							<label for="input-27" class="col-sm-2 col-form-label">Trạng
	...
	<!-- Ajax  -->
	<script src="/resources/admin/build/customJS/ajaxofgift.js"></script>
